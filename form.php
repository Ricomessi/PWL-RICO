...
<body class="bg-gray-300">
    ...
    <form action="proses.php" method="post" class="max-w-4xl mx-auto p-8 bg-gray-100 rounded-lg shadow-md">
        <div class="mb-4">
            ...
            <input type="text" name="nama" class="w-full form-input">
        </div>

        <div class="mb-4">
            <label for="alamat" class="block text-gray-700">Alamat:</label>
            <textarea name="alamat" rows="4" class="w-full form-input"></textarea>
        </div>

        <div class="mb-4">
            <label for="hp" class="block text-gray-700">Nomor HP:</label>
            <input type="text" name="hp" class="w-full form-input">
        </div>

        <div class="mb-4">
            <label for="tgl_transaksi" class="block text-gray-700">Tanggal Transaksi:</label>
            <input type="date" name="tgl_transaksi" class="w-full form-input">
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nama_barang" class="w-full form-input">
        </div>

        <div class="mb-4">
            <label for="jumlah" class="block text-gray-700">Jumlah:</label>
            <input type="number" name="jumlah" class="w-full form-input">
        </div>

        <div class="mb-4">
            <label for="harga" class="block text-gray-700">Harga:</label>
            <input type="number" name="harga" class="w-full form-input">
        </div>

        <div class="mb-4">
            <input type="submit" value="Simpan" class="w-full btn btn-primary bg-gray-600">
        </div>
    </form>
